...
const cardStyles = {
  ...
  border: "#B2955E",
  borderRadius: "22px",
  background: "linear-gradient(45deg, #F4E772 0%, #DDAF1B 34.54%, #FDF683 66.38%, #F0CE50 100%)",
};
  ...
  return (
    <section>
      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={2} marginY={3}> {/* Increase spacing here */}
          <Grid item xs={12} sm={6} md={3} lg={6}>
            <Box sx={{ background: "#CEDBD8", boxShadow: "0px 1px 1px 0px #CEDBD8", width: "100%", height: "52px", display: "flex", gap: 2, paddingLeft: 3, alignItems: "center" }}>
              <Typography><svg width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <Typography sx={{ fontWeight: 700, fontSize: "20px", lineHeight: "24px", color: "#000000CC" }} variant="h6">Member Details</Typography>
            </Box>
          </Grid>
          <Grid item xs={12} sm={6} md={3} lg={6}>
            <Box sx={{ background: "#CEDBD8", boxShadow: "0px 1px 1px 0px #CEDBD8", width: "100%", height: "52px", display: "flex", gap: 2, paddingLeft: 3, alignItems: "center" }}>
              ...
              <Typography sx={{ fontWeight: 700, fontSize: "20px", lineHeight: "24px", color: "#000000CC" }} variant="h6">Cashback Details</Typography>
            </Box>
          </Grid>
        </Grid>
        ...
        <Box>
          <Grid container spacing={2}>
            <Grid item xs={12} sm={6} md={3} lg={6}>
              <Box sx={{ background: "#0C4433", gap: "20px", width: "100%", height: "450px", padding: "22px 47px", borderRadius: "33px" }}>
                ...
                <Box
                  sx={{
                    ...
                    alignItems: "center",
                    position: "relative" // Ensure this is set for proper positioning
                  }}
                >
                  <Box
                    sx={{
                    ...
                    {FirstCardData?.map((item, index) => (
                      <TableRow key={index} sx={{ '&:last-child td, &:last-child th': { border: 'none' } }}>
                        <TableCell
                          component="th"
                          scope="row"
                          sx={{ padding: 0, fontWeight: 400, fontSize: "15px", lineHeight: "20px", color: "#FFFFFF", border: 'none' }}
                        >
                          {item?.label}
                        </TableCell>
                        <TableCell
                          align="left"
                          sx={{ padding: 0, fontWeight: 700, fontSize: "15px", lineHeight: "20px", color: "#FFFFFF", paddingY: 1, border: 'none' }}
                        >
                          {item.value}
                        </TableCell>
                      </TableRow>
                ...
                <Box sx={{ display: "flex", gap: 3, marginTop: 2 }}>
                  <Box sx={{ border: "1px solid #03C136", display: "flex", alignItems: "center", borderRadius: "22px", paddingX: 2, gap: "10px" }}>
                    <Box>
                    ...
                    <Box sx={{ color: "#FFFFFF", fontWeight: 400, fontSize: "15px", lineHeight: "20px", width: "120px", height: "11px" }}>Edit Member Info</Box>
                  </Box>
                  <Button sx={{ background: "#03C136", borderRadius: "22px", padding: "22px", gap: "10px", width: "188px", height: "55px", textTransform: "capitalize" }}><Typography sx={{ fontWeight: 700, fontSize: "15px", lineHeight: "20px", color: "#FFFFFF" }}>Renew Membership</Typography> </Button>
                </Box>
              </Box>
            </Grid>
            <Grid item xs={12} sm={6} md={3} lg={6}>
              <Box sx={{ display: "flex", flexDirection: "column" }}>
                <Box sx={{ background: "#0C4433", gap: "20px", width: "100%", height: "450px", padding: "22px 47px", borderRadius: "33px", display: "flex", flexDirection: "column" }}>
                  ...
                  <Box sx={{ background: "#00291C", width: "115%", padding: "11px 47px", marginTop: "20px", display: "flex", marginLeft: -5.6 }}>
      ...
      <Box>
        <Box sx={{ background: "#CEDBD8", boxShadow: "0px 1px 1px 0px rgba(206, 219, 216, 1)", height: "52px", width: "100%", padding: "11px 47px", gap: "10px", marginTop: 2 }}>
      ...
      <Container maxWidth="xl" sx={{ marginBottom: 4 }}>
        ...
        <Box sx={{ display: "flex", gap: 3, marginTop: 2 }}>
          <Box sx={{ border: "1px solid #03C136", display: "flex", alignItems: "center", borderRadius: "22px", paddingX: 2, gap: "10px", width: "200px" }}>
            <Box>
            ...
            <Box sx={{ color: "#000000CC", fontWeight: 400, fontSize: "15px", lineHeight: "20px", width: "184px", height: "11px" }}>Add Family Member</Box>
          </Box>
          <Box>
