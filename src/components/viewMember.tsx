  ...
  return (
    <section>
      ...
      <Container maxWidth="xl">
        ...
        <Grid container marginY={3} spacing={2} sx={{ background: "#CEDBD8" }}>
          <Container maxWidth="xl">
            <Grid container item spacing={2}>
              <Grid item xs={12} sm={6} md={3} lg={6}>
                <Box sx={{ boxShadow: "0px 1px 1px 0px #CEDBD8", background: "#CEDBD8", width: "100%", height: "52px", display: "flex", gap: 2, paddingLeft: 3, alignItems: "center" }}>
                  <Typography>
